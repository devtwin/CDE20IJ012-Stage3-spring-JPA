...
public class StockService {
	...
	public List<Stock> getByCodeAndDate() {
		return stockRepository.findByCodeAndDateBetween("FB", Date.valueOf("2019-09-01"), Date.valueOf("2019-09-10"));
	}

	@Transactional
	public List<Stock> getByCodeAndStockPrice() {
		return stockRepository.findByCodeAndCloseGreaterThan("GOOGL", new BigDecimal(184.00));
	}
